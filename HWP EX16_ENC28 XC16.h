...
#include "Compiler.h"
#include "HWP EX16_ENC28 XC16.h"

// Define a macro describing this hardware set up (used in other files)
#define EXPLORER_16

// Clock frequency values
#define MAXIMUM_PIC_FREQ		(16000000ul)
...
#define BUTTON0_TRIS		(TRISBbits.TRISB12)	// Ref S4
...
#define UARTRX_TRIS			(TRISFbits.TRISF3)
#define UARTRX_IO			(PORTFbits.RF3)
...
//	#define ENC_CS_IO			(LATDbits.LATD7)
	...
	#define ENC_SPI_IF			(IFS1bits.SPI1IF)
...
//#else
	#define ENC100_INT_TRIS				(TRISAbits.TRISA14)		// INT signal is optional and currently unused in the Microchip TCP/IP Stack.  Leave this pin disconnected and comment out this pin definition if you don't want it.
	#define ENC100_INT_IO				(PORTAbits.RA14)
//#endif
...
//	#else	// All other PIC24s, dsPICs, and PIC32s use SPI1 slot (top most closest to LCD)
		#define ENC100_CS_TRIS					(TRISGbits.TRISG8)	// CS is mandatory when using the SPI interface
...
//#define EEPROM_CS_IO		(LATDbits.LATD6)
//
...
//#define UART1TX_TRIS		(TRISFbits.TRISF8)
//#define UART1TX_IO			(PORTFbits.RF8)
//#define UART1RX_TRIS		(TRISFbits.TRISF3)
//#define UART1RX_IO			(PORTFbits.RF3)
