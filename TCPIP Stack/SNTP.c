...
#define NTP_QUERY_INTERVAL		(1ull*60ull * TICK_SECOND)
//#define NTP_QUERY_INTERVAL		(20ull * TICK_SECOND)
...
#define NTP_REPLY_TIMEOUT		(60ul*TICK_SECOND)
...
//#define NTP_SERVER	"epona.stramatel.local"
